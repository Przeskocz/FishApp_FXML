...
--
-- Host: 127.0.0.1
-- Czas generowania: 17 Sty 2020, 16:41
...
CREATE TABLE IF NOT EXISTS `connect_fish_piscary` (
  ...
  PRIMARY KEY (`cfp_id`),
  KEY `fk_fish` (`cfp_fish_id`),
  KEY `fk_piscary` (`cfp_piscary_id`)
) ENGINE=InnoDB AUTO_INCREMENT=30 DEFAULT CHARSET=utf8;

--
-- Tabela Truncate przed wstawieniem `connect_fish_piscary`
--

TRUNCATE TABLE `connect_fish_piscary`;
--
...
--
-- Tabela Truncate przed wstawieniem `fish`
--
...
CREATE TABLE IF NOT EXISTS `piscary` (
  `piscary_id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`piscary_id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8;

--
-- Tabela Truncate przed wstawieniem `piscary`
--

TRUNCATE TABLE `piscary`;
--
...
(1, 5.00, 'Nad stawami', 'Siedliska 10', '+48 754 220 272', 7, 19, 30, 30, 3, 1, 'pellet halibut,czerwony robak'),
(3, 3.40, 'Ranczo nad jeziorkiem', 'Czarna 803', '+48 665 921 994', 10, 16, 25, 25, 2, 1, 'kulki truskawkowe,biały robak'),
(4, 2.70, 'Staw u Domina', 'Harta 32', '+48 341 664 343', 6, 18, 20, 20, 2, 1, 'kukurydza,kulki pomarańczowe'),
(5, 6.40, 'Hurko', 'Przemyśl 43', '+48 839 843 754', 7, 19, 25, 25, 2, 1, 'kulki ananas, pellet orzech tygrysi');
